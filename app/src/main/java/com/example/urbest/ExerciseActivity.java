...
public class ExerciseActivity extends AppCompatActivity {
    ...
    private ArrayList<String> step, head;
    ...
    Exercise exercise;
    private DatabaseReference favDB;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userID = user.getUid();
        favDB = FirebaseDatabase.getInstance().getReference("favList").child(userID);

        stepText = findViewById(R.id.content);
        headImg = findViewById(R.id.headImage);
        c = findViewById(R.id.collapsing_toolbar);
        floatingActionButton = findViewById(R.id.fab);

        step = exercise.getSteps();
        head = exercise.getHeaders();
        img = exercise.getImages();

        stepText.setText(step.get(key));
    ...
    public void fabClicked(View view) {
        if(clicked == false){
            ...
            insertFavData();
            Snackbar snackbar = Snackbar.make(cor, "The exercise added your favorites.", Snackbar.LENGTH_LONG);
            ...
            removeFavData();
            Snackbar snackbar = Snackbar.make(cor, "The exercise removed from your favorites.", Snackbar.LENGTH_LONG);
            snackbar.setAction("OK", new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    snackbar.dismiss();
    ...
    private void insertFavData() {
        String headData = exercise.getHeaders().get(key);
        int imgData =  exercise.getImages().get(key);
